...
for n=2
    for i=2:10
        ...
        switch i
            case 2
                m(i-1,:)=implicit1(n,i,0,T2,A,p(n-1,i),0,0,0);
            case 3
                m(i-1,:)= implicit1(n,i,T1,T2,A,p(n-1,i),q,0,0);
            case 5
                m(i-1,:)=implicit1(n,i,T1,T2,A,p(n-1,i),0,j1,2200)  ;
            case 9
                m(i-1,:)=implicit1(n,i,T1,T2,A,p(n-1,i),q,0,0);
            case 10
                m(i-1,:)=implicit1(n,i,T1,T2,A,p(n-1,i),T2*5000,0,0);
            otherwise
                m(i-1,:)= implicit1(n,i,T1,T2,A,p(n-1,i),0,0,0);
        end
    end
    x=m(:,2:10);
    y=m(:,12);
